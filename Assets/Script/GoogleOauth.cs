...
{
    private const string ClientId = "157349419219-jl2ufupdnfcm3m04hju0f0arnfr90kr4.apps.googleusercontent.com"; //TODO: Change [CLIENT_ID] to your CLIENT_ID
    private const string ClientSecret = "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"; //TODO: Change [CLIENT_SECRET] to your CLIENT_SECRET

    private static string RedirectUri = "http://localhost:8080/auth/google/callback";
